...
if __name__ == '__main__':
    ...
    directory = os.path.join('/scratch/cl2840/360video/tsinghua/Formated_Data/',experiment)
    user_num = 48
    all_video_data_xyz = {}
    ...
    if cfg.use_xyz:
        pickle.dump(all_video_data_xyz,open('/scratch/cl2840/360video/data/new_exp_'+expNumber+'_xyz.p','wb'))
    if cfg.use_phi_theta:
