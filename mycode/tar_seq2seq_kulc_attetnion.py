...
if use_one_layer:
    ...
    if use_attention_encoder:
        attented_encoder = AttentionRNNWrapper(encoder2)
...
#### ====================data====================
# video_data_train = pickle.load(open('/scratch/cl2840/360video/data/shanghai_dataset_xyz_train.p','rb'),encoding='latin1')    
# datadb_train = clip_xyz(video_data_train)
# video_data_test = pickle.load(open('/scratch/cl2840/360video/data/shanghai_dataset_xyz_test.p','rb'),encoding='latin1')    
...
### ====================Training====================
tag='taronly_seq2seq_2layer_full_attention_embedding_nonint'
