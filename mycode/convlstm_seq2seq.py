...
if not cfg.use_one_hot:
    ...
    # video_data_train = pickle.load(open('/scratch/cl2840/360video/data/tsinghua_train_video_data.p','rb'))
...
### ====================Testing====================
### data format 3
# video_data_test = pickle.load(open('/scratch/cl2840/360video/data/tsinghua_test_video_data.p','rb'))
# ### data format 4
